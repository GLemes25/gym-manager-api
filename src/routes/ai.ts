...
export const aiRoutes = async (app: FastifyInstance) => {
  // app.post("/ai", async function (request, replay) {
  ...
  //           goal: z.string().describe("Objetivo do plano de treino"),
  ...
  //   response.headers.forEach((value, key) => replay.header(key, value));
  //   return replay.send(response.body);
  // });
        ...
        tools: {
          ...
          updateUserTrainData: tool({
            ...
            inputSchema: z.object({
              ...
              birthDate: z.iso.date().describe("Nascimento do usuário"),
              bodyFatPercentage: z
                .number()
                .int()
                .min(0)
              ...
              workoutDays: z
                .array(
                  z.object({
                    ...
                    weekDay: WeekDaySchema.describe("Dia da semana"),
                    isRestDay: z
                      .boolean()
                      .describe(
