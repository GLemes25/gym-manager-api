...
- O plano DEVE ter exatamente 7 dias (MONDAY a SUNDAY). Dias sem treino = `isRestDay: true`, `exercises: []`, `estimatedDurationInSeconds: 0`. Chame a tool `createWorkoutPlan` para criar o plano de treino.
